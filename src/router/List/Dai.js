...
clickItem(item, index) {
  ...
  console.log(index,this.state.con)
  this.setState({
    index: index
  })
        ...
        <span>处理时间:<RangePicker
              ...
              <span>金额范围(万):
                ...
                -
                  ...
                  let brr = this.state.two = e.target.value;
                  this.setState({
                    two: brr
                  })
...
let initMapDispatchTo=(dispatch)=>{
  return {
    ...
    zz:(data)=>{
      dispatch({type:"ZZ",data:data})
    },
  }
}
export default connect(initMapStateTo,initMapDispatchTo)(Dai)